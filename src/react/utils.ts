...
export function resolveSxValue(key: string, value: SxValue, theme: ThemeConfigs, windowWidth?: number) {
  ...
  if (typeof value === "object" && !Array.isArray(value)) {
    if ("web" in value || "default" in value) {
      const platformValue = value as Record<string, string | number | boolean>;
      value = platformValue.web !== undefined ? platformValue.web : platformValue.default as string | number | boolean;
 ...
 * @returns A resolver function `(theme, props) => CSSProperties`.
 */
export function variants<
  V extends VariantConfig<Configs>,
  Configs extends ThemeConfigs = ThemeConfigs
>(
  base?: Styled<CSSProperties, Configs>,
  configs?: {
    variants?: V;
    defaultVariants?: {
  ...
  return function resolveVariants(
    ...
    return vStyle as CSSProperties;
  };
}
